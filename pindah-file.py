...
def pindah_file_dokumen_mux():
    ...
    for row in records:
        ...
        # Tentukan path sumber dan path destinasi
        path_sumber = "/var/www/html/app-simp3-pra-migrasi/uploads/lampiran_file_temp/"+str(nama_file)
        path_destinasi = "/home/simp3-rebuild/public/storage/file_dokumen_mux/"
        try:
            with open(path_sumber, "r") as file:
                # Lakukan operasi pada file
                shutil.copy(path_sumber, path_destinasi)
...
def pindah_file_visi():
    ...
    for row in records:
        ...
        try:
            ...
            print(f"Kesalahan lain: {e}")
def pindah_file_fotokopi_npwp():
    connection = destinantion_connection()
    cursor = connection.cursor()
    cursor.execute(" SELECT file_fotokopi_npwp from lampiran_penyiaran WHERE file_fotokopi_npwp IS NOT NULL ")
    records = cursor.fetchall()
    for row in records:
        nama_file = row[0]
        # print(nama_file)
        # Tentukan path sumber dan path destinasi
        path_sumber = "/var/www/html/app-simp3-pra-migrasi/uploads/lampiran_file_temp/"+str(nama_file)
        path_destinasi = "/home/simp3-rebuild/public/storage/file_fotokopi_npwp/"
        try:
            with open(path_sumber, "r") as file:
                # Lakukan operasi pada file
                shutil.copy(path_sumber, path_destinasi)
...
def pindah_file_dokumen_ulop():
    connection = destinantion_connection()
    cursor = connection.cursor()
    cursor.execute(" SELECT file_dokumen_ulop from pengajuan_ulop_radio WHERE file_dokumen_ulop IS NOT NULL ")
    records = cursor.fetchall()
    for row in records:
        nama_file = row[0]
        # print(nama_file)
        # Tentukan path sumber dan path destinasi
        path_sumber = "/var/www/html/app-simp3-pra-migrasi/uploads/lampiran_file_temp/"+str(nama_file)
        path_destinasi = "/home/simp3-rebuild/public/storage/file_dokumen_ulop/"
        try:
            with open(path_sumber, "r") as file:
                # Lakukan operasi pada file
                shutil.copy(path_sumber, path_destinasi)
...
def pindah_file_file_afiliasi():
    connection = destinantion_connection()
    cursor = connection.cursor()
    cursor.execute(" SELECT file_afiliasi from lembaga_penyiaran WHERE file_afiliasi IS NOT NULL ")
    records = cursor.fetchall()
    for row in records:
        nama_file = row[0]
        # print(nama_file)
        # Tentukan path sumber dan path destinasi
        path_sumber = "/var/www/html/app-simp3-pra-migrasi/uploads/lampiran_file_temp/"+str(nama_file)
        path_destinasi = "/home/simp3-rebuild/public/storage/file_afiliasi/"
        try:
            with open(path_sumber, "r") as file:
                # Lakukan operasi pada file
                shutil.copy(path_sumber, path_destinasi)
...
def pindah_file_surat_pernyataan_ulop():
    connection = destinantion_connection()
    cursor = connection.cursor()
    cursor.execute(" SELECT file_surat_pernyataan from pengajuan_ulop_tv WHERE file_surat_pernyataan IS NOT NULL ")
    records = cursor.fetchall()
    for row in records:
        nama_file = row[0]
        # print(nama_file)
        # Tentukan path sumber dan path destinasi
        path_sumber = "/var/www/html/app-simp3-pra-migrasi/uploads/lampiran_file_temp/"+str(nama_file)
        path_destinasi = "/home/simp3-rebuild/public/storage/file_surat_pernyataan_ulop/"
        try:
            with open(path_sumber, "r") as file:
                # Lakukan operasi pada file
                shutil.copy(path_sumber, path_destinasi)
...
def pindah_file_aspek_permodalan():
    connection = destinantion_connection()
    cursor = connection.cursor()
    cursor.execute(" SELECT file_aspek_permodalan from lampiran_penyiaran WHERE file_aspek_permodalan IS NOT NULL ")
    records = cursor.fetchall()
    for row in records:
        nama_file = row[0]
        # print(nama_file)
        # Tentukan path sumber dan path destinasi
        path_sumber = "/var/www/html/app-simp3-pra-migrasi/uploads/lampiran_file_temp/"+str(nama_file)
        path_destinasi = "/home/simp3-rebuild/public/storage/file_aspek_permodalan/"
        try:
            with open(path_sumber, "r") as file:
                # Lakukan operasi pada file
                shutil.copy(path_sumber, path_destinasi)
...
def pindah_file_case_flow():
    connection = destinantion_connection()
    cursor = connection.cursor()
    cursor.execute(" SELECT file_case_flow from lampiran_penyiaran WHERE file_case_flow IS NOT NULL ")
    records = cursor.fetchall()
    for row in records:
        nama_file = row[0]
        # print(nama_file)
        # Tentukan path sumber dan path destinasi
        path_sumber = "/var/www/html/app-simp3-pra-migrasi/uploads/lampiran_file_temp/"+str(nama_file)
        path_destinasi = "/home/simp3-rebuild/public/storage/file_case_flow/"
        try:
            with open(path_sumber, "r") as file:
                # Lakukan operasi pada file
                shutil.copy(path_sumber, path_destinasi)
...
def pindah():
    ...
    match num:
        ...
        case '28':
            print("Pindah Foto Rekomendasi")
            pindah_file_surat_pernyataan_ulop()
        case '29':
            print("Pindah Aspek Permodalan")
            pindah_file_aspek_permodalan()
        case '30':
            print("Pindah Case Flow")
            pindah_file_case_flow()
        case _:
            print('Invalid input')
